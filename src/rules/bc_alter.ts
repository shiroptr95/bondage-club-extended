...
export function initRules_bc_alter() {
	...
	registerRule("alt_room_admin_limit", {
		name: "Ограничить полномочия администратора, когда связан",
		type: RuleType.Alt,
		loggable: false,
		shortDescription: "ограничить полномочия администратора комнаты, пока он связан",
	...
	registerRule("alt_hide_friends", {
		...
		type: RuleType.Alt,
		loggable: false,
		shortDescription: "предотвращение звуковых сигналов из списка друзей - настраиваемые исключения",
